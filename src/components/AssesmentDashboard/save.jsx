                ...
                content={
                  <div className="schools-section">
                    ...
                    <div className="school-recommendations">
                      {results.analysis.careerRecommendations.slice(0, 3).map((career, index) => (
                        <div key={index} className="school-recommendation-item">
                          ...
                          <Link to={`/explore/schools?career=${career.jobTitle.toLowerCase().replace(/\s+/g, "-")}`}>
                            <button className="school-explore-button">
                    ...
                    <div className="mentor-recommendations">
                      {results.analysis.careerRecommendations.slice(0, 3).map((career, index) => (
                        <div key={index} className="mentor-recommendation-item">
                          ...
                          <Link to={`/explore`}>
                            <button className="mentor-explore-button">
